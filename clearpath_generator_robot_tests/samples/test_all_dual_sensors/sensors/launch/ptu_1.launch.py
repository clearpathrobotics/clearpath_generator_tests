        ...
        launch_arguments=
            [
                (
                    'parameters'
                    ,
                    '/home/tbaltovski/ptu/src/clearpath_generator_tests/clearpath_generator_robot_tests/samples/test_all_dual_sensors/sensors/config/ptu_1.yaml'
                )
                ,
                (
                    'namespace'
                    ,
                    'cpr_generic_e/sensors/ptu_1'
                )
                ,
                (
                    'robot_namespace'
