        ...
        launch_arguments=
            [
                (
                    'parameters'
                    ,
                    '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_robot_tests/samples/test_all_dual_sensors/sensors/config/imu_0.yaml'
                )
                ,
                (
                    'namespace'
