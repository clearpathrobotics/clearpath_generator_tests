        ...
        launch_arguments=
            [
                (
                    'parameters'
                    ,
                    '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_tests/samples/robot_samples/test_r100/sensors/config/lidar2d_0.yaml'
                )
                ,
                (
                    'namespace'
                    ,
                    'r100_0000/sensors/lidar2d_0'
                )
                ,
                (
                    'robot_namespace'
