        ...
        launch_arguments=
            [
                (
                    'parameters'
                    ,
                    '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_tests/samples/robot_samples/test_all_dual_sensors/sensors/config/camera_4.yaml'
                )
                ,
                (
                    'namespace'
                    ,
                    'cpr_generic_e/sensors/camera_4'
                )
                ,
                (
                    'robot_namespace'
