...
def generate_launch_description():
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_dd100/platform/config/imu_filter.yaml',
        description='')
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_dd100'
                )
                ,
                (
                    'use_sim_time'
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'dd100_0000/cmd_vel@geometry_msgs/msg/TwistStamped[gz.msgs.Twist'
                ,
                '/model/dd100_0000/robot/cmd_vel@geometry_msgs/msg/TwistStamped]gz.msgs.Twist'
                ,
            ]
        ,
        remappings=
            [
                ...
                ,
                (
                    '/model/dd100_0000/robot/cmd_vel'
                    ,
                    'platform/cmd_vel'
                )
                ,
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/dd100_0000/robot/tf@tf2_msgs/msg/TFMessage[gz.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_dd100/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
