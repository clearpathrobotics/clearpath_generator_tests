            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/tbaltovski/empty/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_a300_empty_ns/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
