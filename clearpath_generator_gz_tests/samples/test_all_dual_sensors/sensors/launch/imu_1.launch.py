            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_all_dual_sensors/sensors/config/imu_1.yaml'
                    ,
                }
                ,
            ]
    ...
    node_imu_1_static_tf = Node(
        ...
        arguments=
            [
                ...
                '--child-frame-id'
                ,
                'cpr_generic_e/robot/base_link/imu_1'
                ,
            ]
        ,
        remappings=
