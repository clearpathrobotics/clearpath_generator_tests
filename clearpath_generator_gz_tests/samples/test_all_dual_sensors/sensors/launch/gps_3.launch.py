...
def generate_launch_description():
    ...
    # Nodes
    node_gps_3_gz_bridge = Node(
        name='gps_3_gz_bridge',
    ...
    node_gps_3_static_tf = Node(
        name='gps_3_static_tf',
        ...
        arguments=
            [
                ...
                '--child-frame-id'
                ,
                'cpr_generic_e/robot/base_link/gps_3'
                ,
            ]
        ,
        remappings=
    ...
    ld.add_action(node_gps_3_gz_bridge)
    ld.add_action(node_gps_3_static_tf)
    return ld
