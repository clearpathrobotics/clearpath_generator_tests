...
def generate_launch_description():
    ...
    launch_arg_imu_filter = DeclareLaunchArgument(
        'imu_filter',
        default_value='/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_j100/platform/config/imu_filter.yaml',
        description='')
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_j100'
                )
                ,
                (
                    'use_sim_time'
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_j100/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_j100/sensors/config/gps_0.yaml'
                    ,
                }
                ,
            ]
