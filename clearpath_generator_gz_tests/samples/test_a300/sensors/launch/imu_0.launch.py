            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/lcamero/Workspaces/sample_ws/src/clearpath_generator_tests/clearpath_generator_gz_tests/samples/test_a300/sensors/config/imu_0.yaml'
                    ,
                }
                ,
            ]
    ...
    node_imu_0_static_tf = Node(
        ...
        arguments=
            [
                ...
                '--child-frame-id'
                ,
                'a300_00000/robot/base_link/imu_0'
                ,
            ]
        ,
        remappings=
